...
class AppointmentNotification(models.Model):
    ...
    # \u2500\u2500 Localized display \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    # Notifications are stored bilingually at creation time: Arabic in
    # title/message, English in title_en/message_en. These properties return
    # the stored English text for an English UI, falling back to the Arabic
    # original (the true event) when no English text was stored.
    ...
    def localized_title(self):
        if self._is_english() and self.title_en:
            return self.title_en
        return self.title

    @property
    def localized_message(self):
        if self._is_english() and self.message_en:
