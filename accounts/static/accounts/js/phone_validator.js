 ...
 * phone_validator.js
 *
 * Unified, real-time phone number validator for Palestinian numbers.
 * Accepted formats: 059XXXXXXX  /  056XXXXXXX  /  +97059XXXXXXX  /  +97056XXXXXXX
 *
...
(function () {
    ...
    var HINT       = '059XXXXXXX أو 056XXXXXXX';
    var VALID_MSG  = 'صيغة صحيحة ✓';
    var BAD_PREFIX = 'يجب أن يبدأ بـ 059 أو 056';
    ...
    function validate(input, ind) {
        ...
        // Wrong prefix (detectable after 3+ digits)
        if (digits.length >= 3 && !digits.startsWith('059') && !digits.startsWith('056')) {
